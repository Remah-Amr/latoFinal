...
const transproter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
           user: 'latokalatohamato@gmail.com', // must go to الامان then وصول التطبيقات الاقل أمانا https://myaccount.google.com/lesssecureapps
           pass: 'mohamed1111'          // https://accounts.google.com/b/0/DisplayUnlockCaptcha 
...
app.post('/otp/send',async(req,res,next)=>{
    ...
    transproter.sendMail({
       ...
       }).then(msg => console.log('sent')).catch(err => console.log(err))
